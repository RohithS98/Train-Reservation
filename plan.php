...
<html>
    ...
    <body>
        ...
        <div class="container col-6" style="margin: 5rem auto auto auto; text-align: center; ">

            <h3 class="display-3" style="width: 100%;text-align:center;text-decoration-color: white !important;">Plan Your Journey</h3>
            <div class="row">
                <div class="col"></div>
                <div class="col">
            ...
            <div class="input-group input-group-lg row" style="margin: 10 10 0 0 !important;">
                <div class="col-12" style="margin-bottom: 1rem;"><input class="form-control" type="text" id="from" placeholder="From Station"></div>
                <div class="col-12" style="margin-bottom: 1rem"><input class="form-control" type="text" id="to" placeholder="To Station"></div>
            </div>
            <hr>
            ...
            <hr>
            <br>
            <button type="button" class="btn btn-success" style="width: 100%; margin-bottom: 2rem;" id="submitButton">Book Ticket</button>
            <h3 id="ticketStatus"></h3>
        </div>
        <div class="col"></div>
</body>
</html>
...
$(document).ready(function(){
    ...
    function getPrice(){
        document.getElementById("cost").innerHTML = "₹ " + 100*i;
    }
